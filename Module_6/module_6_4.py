...
просто хотел бы понять, 
есть ли решение с использованием атрибута радиус (раз уж и в инструкции говорится - 3. Метод get_square возвращает
                                                площадь круга (можно рассчитать как через длину, так и через радиус).),
или это лишние сложности
'''
